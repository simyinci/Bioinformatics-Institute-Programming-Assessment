...
def fill_alt (grid, L, col, beads, t_bead, bead, i, j, k, first):
    ...
    if (j >= L):
        ...
        if (i >= L):
            ...
            first = False   # change reference point as alternate grid spaces 
                            # wrt grid[0][0] are completely filled
        
        # update colum index wrt to reference point and row index
        if first:
            if (i%2 == 0):
                j = 0
            else:
...
def place_beads (L, col, beads):
    ...
    # filled with beads of largest quantity till the least in all situations
...
# =============================================================================
# Test X - 5 x 5 square grid - 2 bead colours
# =============================================================================
sys.stdout = open('output_question_5x', 'w')
...
col = ['R', 'B']   # list of bead colours
beads = [5, 20]    # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()

col = ['R', 'B']   # list of bead colours
beads = [2, 23]    # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()

col = ['R', 'B', 'G']   # list of bead colours
beads = [5, 15, 5]      # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()
...
# =============================================================================
# Test Y - 6 x 6 square grid - 2 bead colours
# =============================================================================
sys.stdout = open('output_question_5y', 'w')

L = 6              # dimension of square grid

col = ['R', 'B']   # list of bead colours
beads = [18, 18]   # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()

col = ['R', 'B']   # list of bead colours
beads = [16, 20]   # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()

col = ['R', 'B']   # list of bead colours
beads = [9, 27]    # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()

col = ['R', 'B']   # list of bead colours
beads = [4, 32]    # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()
...
# =============================================================================
# Test Z - 64 x 64 square grid - 5 bead colours
# =============================================================================
sys.stdout = open('output_question_5z', 'w')
...
col = ['R', 'B', 'G', 'W', 'Y']       # list of bead colours
beads = [139, 2050, 378, 1072, 457]   # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()

col = ['R', 'B', 'G', 'W', 'Y']      # list of bead colours
beads = [139, 2150, 378, 972, 457]   # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()

col = ['R', 'B', 'G', 'W', 'Y']       # list of bead colours
beads = [139, 2300, 378, 1072, 207]   # list of bead quantity wrt col
# output the bead placement
place_beads(L, col, beads)
print()
